...
import { UserService } from '@app/submodules/admin/submodules/user/services/user.service';
import {
	USER_GET,
	userGetFailure,
	userGetSuccess,
} from '@app/submodules/admin/submodules/user/actions/user-get.actions';
...
import {
	...
	userGetPagedFailure,
	userGetPagedSuccess,
} from '@app/submodules/admin/submodules/user/actions/user-get-paged.actions';
...
import {
	...
	userDeleteFailure,
	userDeleteSuccess,
} from '@app/submodules/admin/submodules/user/actions/user-delete.actions';
import {
	USER_UPDATE,
	userUpdateFailure,
	userUpdateSuccess,
} from '@app/submodules/admin/submodules/user/actions/user-update.actions';
import {
	USER_CREATE,
	userCreateFailure,
	userCreateSuccess,
} from '@app/submodules/admin/submodules/user/actions/user-create.actions';
